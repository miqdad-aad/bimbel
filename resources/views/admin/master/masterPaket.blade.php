        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            <div class="card-body py-3">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="btn-group">
                            <a onclick="renderForm()" class="btn btn-primary" data-bs-toggle="modal"
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render : function(meta,data,row){
                        return accounting.formatNumber(row.harga);
                    }
                },
                {
                    data: 'gambar',
                    ...
                    render: function (meta, data, row, type) {
                        return '<img style="max-width: 100px;" src="' + row.url_gambar +'" />';
                    },
                },
                {
                    data: 'action',
