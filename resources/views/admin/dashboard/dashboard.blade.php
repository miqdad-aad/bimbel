                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                        data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0c0cb063b"
            ...
            <div class="card-body pt-5">
                ...
                <div class="timeline-label">
                    ...
                    <div class="timeline-item">
                        ...
                        <!--end::Badge-->
                        <!--begin::Text-->
                        <div class="timeline-content fw-mormal text-muted ps-3">Finance KPI Mobile app launch preparion
                            meeting</div>
                        <!--end::Text-->
                    </div>
                    <!--end::Item-->
                        ...
                        <tbody>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Jessie
                                                Clarcson</a>
                                            <span class="text-muted fw-bold text-muted d-block fs-7">C#, ASP.NET, MS
                                                SQL</span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-5.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body pt-5">
                ...
                <div class="d-flex align-items-sm-center mb-7">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <span class="symbol-label">
                            <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/plurk.svg') }}"
                ...
                <div class="d-flex align-items-sm-center mb-7">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <span class="symbol-label">
                            <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/telegram.svg') }}"
                                class="h-50 align-self-center" alt="" />
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <span class="symbol-label">
                            <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/vimeo.svg') }}"
                                class="h-50 align-self-center" alt="" />
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <span class="symbol-label">
                            <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/bebo.svg') }}"
                                class="h-50 align-self-center" alt="" />
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <span class="symbol-label">
                            <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/kickstarter.svg') }}"
                                class="h-50 align-self-center" alt="" />
                        </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <div class="mt-5">
                    ...
                    <div class="d-flex flex-stack mb-5">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <div class="symbol symbol-50px me-3">
                                <div class="symbol-label bg-light">
                                    <img src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/figma-1.svg') }}"
                                        class="h-50" alt="" />
                                </div>
                            </div>
                            <!--end::Symbol-->
