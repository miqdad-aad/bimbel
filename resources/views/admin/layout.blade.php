...
<head>
    <base href="">
    <title>Bimbel - Military Forces</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ asset ('assetsAdmin/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset ('assetsAdmin/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
...
<body id="kt_body"
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="../../demo1/dist/index.html">
                        <img alt="Logo" src="{{ asset ('assetsAdmin/assets/media/logos/logo-1-dark.svg') }}"
                            class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo1/dist/pages/licenses.html">
                                            ...
                                            <span class="menu-title">Master data kegiatan</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="../../demo1/dist/index.html" class="d-lg-none">
                                <img alt="Logo" src="{{ asset ('assetsAdmin/assets/media/logos/logo-2.svg') }}"
                                    class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                                            ...
                                            <div
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3" href="#" title="Coming soon"
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                        ...
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                            style="background-image:url('{{ asset ('assetsAdmin/assets/media/misc/pattern-1.jpg') }}')">
                                            <!--begin::Title-->
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="text-center px-4">
                                                        <img class="mw-100 mh-200px" alt="image"
                                                            src="{{ asset ('assetsAdmin/assets/media/illustrations/sketchy-1/1.png') }}" />
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                        data-kt-menu-placement="bottom-end">
                                        <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-1.jpg') }}"
                                            alt="user" />
                                    </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo"
                                                        src="{{ asset ('assetsAdmin/assets/media/avatars/300-1.jpg') }}" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                                ...
                                                <span class="menu-title position-relative">Language
                                                    <span
                                                        ...
                                                        <img class="w-15px h-15px rounded-1 ms-2"
                                                            src="{{ asset ('assetsAdmin/assets/media/flags/united-states.svg') }}"
                                                            alt="" /></span></span>
                                            </a>
                                            <!--begin::Menu sub-->
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{ asset ('assetsAdmin/assets/media/flags/spain.svg') }}"
                                                                alt="" />
                                                        </span>Spanish</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{ asset ('assetsAdmin/assets/media/flags/germany.svg') }}"
                                                                alt="" />
                                                        </span>German</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{ asset ('assetsAdmin/assets/media/flags/japan.svg') }}"
                                                                alt="" />
                                                        </span>Japanese</a>
                                                </div>
                                                <!--end::Menu item-->
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{ asset ('assetsAdmin/assets/media/flags/france.svg') }}"
                                                                alt="" />
                                                        </span>French</a>
                                                </div>
                                                <!--end::Menu item-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-14.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-2.jpg') }}"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-20.jpg') }}"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-23.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="{{ asset ('assetsAdmin/assets/media/svg/files/pdf.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset ('assetsAdmin/assets/media/svg/files/doc.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset ('assetsAdmin/assets/media/svg/files/css.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset ('assetsAdmin/assets/media/stock/600x400/img-29.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset ('assetsAdmin/assets/media/stock/600x400/img-31.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset ('assetsAdmin/assets/media/stock/600x400/img-40.jpg') }}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset ('assetsAdmin/assets/media/avatars/300-4.jpg') }}"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset ('assetsAdmin/assets/media/avatars/300-25.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset ('assetsAdmin/assets/media/avatars/300-1.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="{{ asset ('assetsAdmin/assets/media/svg/card-logos/visa.svg') }}"
                                                        alt="" class="h-25px" />
                                                    <img src="{{ asset ('assetsAdmin/assets/media/svg/card-logos/mastercard.svg') }}"
                                                        alt="" class="h-25px" />
                                                    <img src="{{ asset ('assetsAdmin/assets/media/svg/card-logos/american-express.svg') }}"
                                                        alt="" class="h-25px" />
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="{{ asset ('assetsAdmin/assets/media/illustrations/sketchy-1/9.png') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bolder w-100 mb-8">
                        <img alt="Logo" src="{{ asset ('assetsAdmin/assets/media/svg/brand-logos/google-icon.svg') }}"
                            class="h-20px me-3" />Invite Gmail Contacts</div>
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-6.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-5.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-25.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-9.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-23.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-12.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-13.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset ('assetsAdmin/assets/media/avatars/300-21.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-5">
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="{{ asset ('assetsAdmin/assets/media/illustrations/sketchy-1/1.png') }}"
    ...
    <script src="{{ asset ('assetsAdmin/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <!--end::Page Vendors Javascript-->
    <!--begin::Page Custom Javascript(used by this page)-->
    <script src="{{ asset ('assetsAdmin/assets/js/widgets.bundle.js') }}"></script>
    <script src="{{ asset ('assetsAdmin/assets/js/custom/widgets.js') }}"></script>
    <script src="{{ asset ('assetsAdmin/assets/js/custom/apps/chat/chat.js') }}"></script>
